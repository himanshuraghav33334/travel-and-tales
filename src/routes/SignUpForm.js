          ...
          <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0  dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handleLogin} class="space-y-4 md:space-y-6" action="#">
                ...
                <div>
                  <label for="username" class="block mb-2 text-sm font-medium text-gray-900 ">Address</label>
                  <input type="text"
                    value={username}
                    onChange={(e) => setUsername(e.target.value)} name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="name@company.com" required="" />
                </div>
                ...
                <div class="flex items-center justify-between">
                  ...
                  </div>                <a href="#" class="text-sm font-medium text-primary-600 hover:underline "></a>
                </div>
                <button type="submit" class="w-full  text-white bg-black hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "><Link to="/login" >Signup</Link></button>
                <p class="text-sm font-light text-gray-500 ">
                  Do you have an account <a href="#" class="font-medium text-primary-600 hover:underline "><Link to="/login" >Sign In</Link></a>
                </p>
              </form>
            </div>
          </div>
